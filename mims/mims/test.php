          ...
          <div class="carousel-item active">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <div class="img-box">
                    <img src="images/young-woman-pharmacist-pharmacy.jpg" style="border-radius: 30px;" height="400px" alt="">
                  </div>
                </div>
                <div class="col-md-8">
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="detail-box">
                    ...
                    <p>
                      Our Mims system offers analysis based on quantity and expiration date .
                    </p>
                    <div>
                      <a href="">
                        Buy Now
      ...
      <div class="feature_container">
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Delivery within 24 hr, where we cover all egypt regions.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Our Medicines are approved from the government. 
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Our support team are available for 24 hrs.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-3 col-md-5 offset-md-2">
          <div class="detail-box">
            <h2>
              ...
              available
              <span>
                in our medicines store
              </span>

            </h2>
            <p>
              Medicine store add their existing medicines with best price.
            </p>
            <div>
              <a href="">
                Buy Now
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="client_container layout_padding2">
              <div class="client_detail">
                <p>
                  The system helps me in buying all drugs that i need, it is very helpful and offers fast delivery.
                </p>
              </div>
              <div class="client_box ">
                <div class="img-box">
                  <img src="images/person1.jpg" class="clientsimage" alt="">
                </div>
                <div class="name">
                  <h5>
                  </h5>
          ...
          <div class="carousel-item">
            <div class="client_container layout_padding2">
              <div class="client_detail">
                <p>
                  The system helps buying all drugs for my grand mother with best price without searching in all medicines store.
                </p>
              </div>
              <div class="client_box ">
                <div class="img-box">
                  <img src="images/person2.png" class="clientsimage" alt="">
                </div>
                <div class="name">
                  <h5>
                  </h5>
          ...
          <div class="carousel-item">
            <div class="client_container layout_padding2">
              <div class="client_detail">
                <p>
                  The system helps me to get all insuline syringe that i need every month.
                </p>
              </div>
              <div class="client_box ">
                <div class="img-box">
                  <img src="images/person3.jpg" class="clientsimage" alt="">
                </div>
                <div class="name">
                  <h5>
                  </h5>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="detail-box">
            ...
            <p>
              There are many medicines that offers and update each their drugs available in the stock.
            <br>
              The delivery guys are available to offers you the drugs withing 24hrs.
            </p>
          </div>
        </div>
      </div>
