            ...
            <div class="row m-0 p-3 justify-content-between">
                ...
                <div class="detail-box">
                    ...
                    if (trim(strtolower($row['location1'])) == trim(strtolower($row["location2"]))) {
                        echo '<h7 class="price">
                        <b style="color:#178066">Description </b> Additional delivery charge with ability to increase depending on availability
                        <span>
                        $
                        </span>
                        20
                ...
                <?php
                    ...
                    <form action="medicine.php" method="POST" >
                        <div class="form-group ">
                            <label for="inputPassword" class="col-form-label">Quantity</label>
                            ...
                            <input type="number" class="form-control" name="qu" id="inputPassword" placeholder="Quantity">
                                ...
                                <div class="card-container">
                                    ...
                                    <input 
                                    placeholder="0000 0000 0000 0000" required onkeyup="$cc.validate(event)" name="creditcard" />
                        ...
                        <!-- </div> -->
                        <input type="submit" value="Submit" name="submit1" class="btn btn-sm btn-default text-white"
