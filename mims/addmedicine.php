                    ...
                    <form enctype="multipart/form-data" method="POST" action="addmedicine.php">
                        ...
                        <div class="row">
                            <div class="col form-group">
                                ...
                                <input type="text" required name="branch" class="form-control" id="br">
                            </div>
                        </div>
...
if (isset($_POST['submit'])) {
    ...
    $idusers = $_SESSION["userid"];
        ...
        $query = "insert into medicine (name,description,category,regdate,expdate,validity_period,quantity,image,price,idusers,branch) values ('$mname','$mdescription','$mcategory','$mregdate','$mexpdate','$mperiod','$mquantity','$profile_pic','$mprice','$idusers','$mbranch')";
